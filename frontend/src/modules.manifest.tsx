...
import { morpionModule } from 'src/modules/morpion/morpion.module';
import { puissance4Module } from 'src/modules/puissance4/puissance4.module';
 ...
 */
export const MODULES: ModuleManifest[] = [imagierModule, tablesModule, calculModule, monnaieModule, snakeModule, heureModule, conjugaisonModule, geoModule, franceModule, lectureModule, numerationModule, memoryModule, penduModule, poseModule, dicteeModule, geometrieModule, grammaireModule, accordsModule, morpionModule, puissance4Module, compteModule];
